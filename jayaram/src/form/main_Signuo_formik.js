...
import TwoFactorVerificationForm, { AutoSubmitToken } from './useField';
import Example from './drag_selectbox_useformikcon';
import Select_boxComponent from './drag_selectbox_useformikcon';
import State_to_formikComponent from './State_to_formik';
import Exampleselect from './multiselectbox';
import Checked_conditionvalidComponent from './checked_condition_valid';
import FieldarrayComponent from './fieldarrayvalidate';
import Alphabetsvalidation from './alphabetsvalidation';
...
function Main_formikComponent() {
    ...
    const validationSchema = Yup.object({
        ...
        checked: Yup.array().required('Permission not checked').min(2),
    ...
    return (
        <div className="mb-5">
                    ...
                    {({ isvalid, isSubmitting }) => (
                        <Form className="w-50">
                            ...
                            <div className="mt-3 text-right">
                                <button className="btn btn-primary" type="submit" disabled={isvalid && isSubmitting} > Submit </button>
                                <button className="btn btn-primary ml-5" type="reset" disabled={Formik.isvalid} > reset </button>
                            </div>
                            {/* <Example/> */}

                            {/* <State_to_formikComponent/> */}
                        </Form>
                    )}
                </Formik>
                <div>
            ...
            {/* <Formik_boxComponent /> */}
            <Checked_conditionvalidComponent />
            <Alphabetsvalidation />
            {/* <FieldarrayComponent/> */}
