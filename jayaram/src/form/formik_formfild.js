...
const SignupForm = () => {
    return (
        <Formik
            initialValues={{ firstName: '', lastName: '', email: '', color: 'red', acceptTerms: [] }}
            validationSchema={Yup.object({
                ...
                acceptTerms: Yup.array().required("required"),
                // Yup.boolean()
        ...
        >
            <Form className="w-25 m-auto">
                ...
                <Field type="checkbox" name="acceptTerms" value="One" />
                
                <Field type="checkbox" name="acceptTerms" value="two"  />
