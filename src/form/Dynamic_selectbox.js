            ...
            <div id="container" >
                <Formik
                    ...
                    <Form className="d-flex justify-content-around mt-4" >
                        ...
                        <Field value={this.state.selectedState} onChange={this.changeState} className="form-control w-25 " as="select" name="country">
                        ...
                        <Field className="form-control w-25 " as="select" name="country">
                            {this.state.selectedState && this.state.countries ? <option>--Choose City--</option> : null}
