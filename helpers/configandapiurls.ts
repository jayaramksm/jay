...
const getDashboardInterval = () => {
    return appsetting.dashboardInterval;
}
const getCaremapPath = () => {
    return appsetting.caremapPath;
}
...
const getversionCheckInterval = (): number => {
    return appsetting.versionCheckInterval;
}
export { getDashboardInterval, getversionCheckInterval, getCaremapPath, getShowMessagecode, getAutoRefresing, getTokenServingInterval, getautoRefreshTime, getSessionTime, setAppsetting, getAppsetting, setApiUrlsData, getApiServiceUrlByComponentAndMethod }
